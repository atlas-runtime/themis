...
bench() {
    ...
    OUT=benchmarks/iot_paper/$1/results
    mkdir -p ${OUT}
...
do_bench() {
    # reset the file 
    rm -f benchmarks/iot_paper/$1/run.res
    mkdir -p benchmarks/iot_paper/$1
    touch benchmarks/iot_paper/$1/run.res
...
#do_bench dectree
do_bench Knn
do_bench LinearRegression
do_bench NaiveBayes
do_bench RandomForest
do_bench dj
do_bench ed
