...
${indent}columns: ${matrix.columns}
  ...
  function initialisation(X, Y) {
    ...
    let W = Matrix.zeros(l, p); // precomputes part of pseudoinverse
...
`;
  ...
  */
  ...
  ML.ArrayXY = ArrayXY;
  ML.BitArray = src$3;
  ML.CholeskyDecomposition = CholeskyDecomposition$1;
  ML.ConfusionMatrix = ConfusionMatrix;
  ML.CrossValidation = index$2;
  ML.DecisionTreeClassifier = DecisionTreeClassifier;
  ML.DecisionTreeRegression = DecisionTreeRegression;
  ML.Distance = distances;
  ML.EVD = EVD;
  ML.ExponentialRegression = ExponentialRegression;
  ML.FCNNLS = index$3;
  ML.FNN = FeedForwardNeuralNetwork;
  ML.GSD = index$6;
  ML.HClust = index;
  ML.HashTable = HashTable;
  ML.KMeans = kmeans;
  ML.KNN = KNN;
  ML.KOPLS = KOPLS;
  ML.Kernel = kernel;
  ML.LuDecomposition = LuDecomposition$1;
  ML.Matrix = Matrix$2;
  ML.MatrixLib = MatrixLib;
  ML.MultivariateLinearRegression = MultivariateLinearRegression;
  ML.NaiveBayes = index$1;
  ML.OPLS = OPLS;
  ML.OPLSNipals = OPLSNipals;
  ML.PCA = PCA;
  ML.PLS = PLS;
  ML.Performance = src$1;
  ML.PolynomialRegression = PolynomialRegression;
  ML.PowerRegression = PowerRegression;
  ML.QrDecomposition = QrDecomposition$1;
  ML.Random = Random;
  ML.RandomForestClassifier = RandomForestClassifier;
  ML.RandomForestRegression = RandomForestRegression;
  ML.RobustPolynomialRegression = RobustPolynomialRegression;
  ML.SOM = src;
  ML.SVD = SVD;
  ML.Similarity = similarities;
  ML.SimpleLinearRegression = SimpleLinearRegression;
  ML.SparseMatrix = SparseMatrix;
  ML.TheilSenRegression = TheilSenRegression;
  ML.XSadd = XSadd;
  ML.binarySearch = binarySearch;
  ML.distanceMatrix = distanceMatrix;
  ML.levenbergMarquardt = levenbergMarquardt;
  ML.nGMCA = nGMCA;
  ML.numSort = index$4;
  ML.padArray = src$2;
  ML.savitzkyGolay = savitzkyGolay;

  let entries = Object.keys(ML);
  ML.entries = entries;
