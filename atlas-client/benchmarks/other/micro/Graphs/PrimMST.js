...
class GraphWeightedUndirectedAdjacencyList1 {
  ...
  PrimMST (start) {
    ...
    const graph = new GraphWeightedUndirectedAdjacencyList1()
...
export function PrimMST_bench (size) {
  const graph = new GraphWeightedUndirectedAdjacencyList1()

  for(let i=0; i< size; i++){
   for(let j=0; j< size; j++){
      graph.addEdge(i,j,i%5)
    }
  }
  graph.PrimMST(1)
  return "bench_done"
